...
const SellingCars = () => {
     ...
     const handleFileChange = (event, index) => {
         ...
         // Update the selected file in the array
  ...
  return (
      <div data-aos="fade-up" className="container bg-white px-5 mx-auto py-20 my-8 shadow-2xl">
          ...
          <section className="grid md:grid-cols-2 justify-center items-center gap-10 md:max-w-6xl mx-auto">
              ...
              <div className=" md:col-span-1">
                  ...
                  <Link to="/used-cars" className="mt-8 flex justify-center">
                      <button
